            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-lg-8">
                            <h4 class="col-form-label ">{{$operation->startdate}} ||
                                {{$operation->startdate->diffForHumans()}}</h4>
                        </div>
                    </div>
                    <div class="form-group row m-0">
                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-lg-8">
                            <h4 class="col-form-label ">{{$operation->enddate}}||
                                {{$operation->enddate->diffForHumans()}}</h4>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{ number_format($outsource_performance_km->dwoc +$outsource_performance_km->dwc  ) }}</td>
                            <td>{{ number_format(($outsource_performance_km->dwoc + $outsource_performance->dwc) + ($performance->dwoc + $performance->dwc)  ) }}</td>
                          </tr>
                          <tr>
                            ...
                            <td>{{ number_format($outsource_performance->revenue + ($operation->tariff * $performance->tonekm) ) }}</td>
                          </tr>
                        </tbody>
                      </table>
                ...
                @can('operation edit')
                <div class='ml-1 p-1'>
                    <a href="{{route('operation.edit',['id'=> $operation->id])}}" class="btn btn-info"> <i
