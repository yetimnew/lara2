                ...
                <div class="col-md-12">
                    <div class="form-row">
                        ...
                        <div class="col-md-3 mb3 ">
                            ...
                            <input id="enddate" name="enddate" type="date" placeholder="Start Date" class="form-control"
                                required>
                        </div>
                        <div class="col-md-3 mb3">
...
<div class="pull-right text-center">
    ...
    <h1 class="pl-5 pull-center">Performance of <span
            class="badge badge-secondary">{{$maxDate}}</span><span>{{$newDate}}</span></h1>
</div>
...
<div class="row col-12">
    ...
    <div class="col-lg-2 col-md-3 col-sm-4  p-2">
        <button class='btn btn-outline-success btn-sm btn-block' type='button'> <span
                class='badge badge-danger float-right'>{{$td->number}}</span>
